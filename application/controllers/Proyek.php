...
// Tutup cURL
		...
		$data =[];
		$data['data_proyek'] = $response_data;
	...
	public function tambah_proyek(){
		// URL endpoint RESTful API
		$api_url = 'http://127.0.0.1/My_Script/SCRIPT_PROJECT/client_product/Konsep_OOP/APP_BASE_CI_3/APP_PROYEK/POST/Proyek'; // Ganti dengan URL endpoint Anda
...
// Tutup cURL
	...
	public function delete_proyek( $id_proyek ){
		// URL endpoint RESTful API
		$api_url = 'http://127.0.0.1/My_Script/SCRIPT_PROJECT/client_product/Konsep_OOP/APP_BASE_CI_3/APP_PROYEK/DELETE/Proyek/'.$id_proyek; 
		// Inisialisasi cURL
		$ch = curl_init();
