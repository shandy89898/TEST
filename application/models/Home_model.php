...
class Home_model extends CI_Model{
	...
	public function get_many( $where = [], $nama_tabel = "proyek_lokasi" ){
	...
	public function get_single( $where = [] , $nama_tabel = "proyek_lokasi"){
		// $where itu adalah array associatif [ "nama_kolom" => "value" ]
	...
	public function tambah(){
		...
		$data = array(
			'id_proyek_lokasi' =>  $this->input->post('id') ?  $this->input->post('id') : null,
			'proyek_id' => $this->input->post('proyek_id'),
			'lokasi_id' => $this->input->post('lokasi_id'),
		);
		$tambah_data = $this->db->insert('proyek_lokasi', $data);
		if ( $tambah_data == true ) {
			$response['status'] = true ;
			$response['msg'] = "Home Model berhasil ditambahkan";
		}else{
			$response['status'] = false;
			$response['msg'] = "Home Model gagal ditambahkan, masalah query!!";
		}
		return $response;
