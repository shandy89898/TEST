          ...
          <div class="card card_table">
            ...
            <div class="card-body">
              ...
              <table class="table" border="1">
                ...
                <!-- Loop Data -->
                <?php 
                foreach ($data_template as $key => $row_template_fitur) {?>
                  <tr>
                    <td> <?= $row_template_fitur['id_template_fitur']  ?> </td>
                    <td> <?= $row_template_fitur['file_template']  ?> </td>
                    <td> <?= $row_template_fitur['nama_template']  ?> </td>
                    <td> <?= $row_template_fitur['waktu']  ?> </td>
                    <td class="kolom_status <?= $row_template_fitur['status'] ?>">
                      <button class="btn btn-default">
                        <?= $row_template_fitur['status'] ?> 
                      </button> 
                    </td>
                    <td>
                      <!-- Kolom Opt -->
                      <div class="kolom_opt">
                        ...
                        <div class="menu_opt">
                          ...
                          <a href="<?= base_url() ?>Admin_template_fitur/update/<?= $row_template_fitur['id_template_fitur'] ?>">
                          ...
                          <?php if ( $row_template_fitur['status'] == "ACTIVE" ){ ?>
                            <!-- Jika datanya belum dihapus, maka hapus datanya -->
                            <!-- Menghapus Data -->

                            <a href="<?= base_url() ?>Admin_template_fitur/delete_data/<?= $row_template_fitur['id_template_fitur']  ?>">
                              <div class="menu_colom">
                                <div class="col_icon">
                          ...
                          <?php }else{ ?>
                            ...
                            <a href="<?= base_url() ?>Admin_template_fitur/restore_data/<?= $row_template_fitur['id_template_fitur']  ?>">
                              <div class="menu_colom">
                                <div class="col_icon">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <form action="<?=base_url()?>Admin_template_fitur/tambah" method="post" enctype="multipart/form-data">

        <div class="form-group">
          <label for="nama_template"> Nama Template : </label>
          <input type="text" name="nama_template" id="nama_template" class="form-control" required>
        </div>
        ...
        .form_upload_section .after{
          display: none;
        }
      </style>

      <div class="form-group form_upload_section">
        <label for="nama_template"> Upload File Template : </label>

        <div class="container_formUpload text-center">
          ...
          <!-- Akan muncul ketika file sudah di upload  -->
          <div class="after">
            <h1> <i class="fas fa-file"></i> </h1>
            <h1 id="file_name">  .eksistensi contoh </h1> 
          </div>

          <!-- Melayang, transparan tak terlihat -->
          <input type="file" name="upload_file_template">
