          ...
          <div class="card card_table">
            ...
            <div class="card-body">
              ...
              <table class="table" border="1">
                <tr>
                  <th> Id Jenis Fitur </th>
                  <th> Nama Menu(RL) </th>
                  <th> Nama Jenis Fitur </th>
                  <th> Waktu </th>
                  <th> Status </th>
                  <th> Action </th>
                </tr>
                ...
                <!-- Loop Data -->
                <?php 
                foreach ($data_jenis_fitur as $key => $row_jenisFitur) {?>
                  <tr>
                    <td> <?= $row_jenisFitur['id_jenis_fitur']  ?> </td>
                    <td> <?= $row_jenisFitur['nama_menu']  ?> </td>
                    <td> <?= $row_jenisFitur['nama_jenis_fitur']  ?> </td>
                    <td> <?= $row_jenisFitur['waktu']  ?> </td>
                    <td class="kolom_status <?= $row_jenisFitur['status'] ?>">
                      <button class="btn btn-default">
                        <?= $row_jenisFitur['status'] ?> 
                      </button> 
                    </td>
                    ...
                    <td>
                      ...
                      <div class="kolom_opt">
                        ...
                        <div class="menu_opt">
                          ...
                          <a href="<?= base_url() ?>Admin_jenis_fitur/update/<?=$row_jenisFitur['id_jenis_fitur']?>">
                          ...
                          <?php if ( $row_jenisFitur['status'] == "ACTIVE" ){ ?>
                            <!-- Jika datanya belum dihapus, maka hapus datanya -->
                            <!-- Menghapus Data -->

                            <a href="<?= base_url() ?>Admin_jenis_fitur/delete_data/<?=$row_jenisFitur['id_jenis_fitur']?>">
                              <div class="menu_colom">
                                <div class="col_icon">
                          ...
                          <?php }else{ ?>
                            ...
                            <a href="<?= base_url() ?>Admin_jenis_fitur/restore_data/<?=$row_jenisFitur['id_jenis_fitur']?>">
                              <div class="menu_colom">
                                <div class="col_icon">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="<?=base_url()?>Admin_jenis_fitur/tambah" method="post">

          <div class="form-group">
            <label for="nama_menu"> List Menu Relasi :</label>
            <select class="form-control" id="nama_menu" name="id_menu">
          ...
          <div class="form-group">
            <label for="nama_jenis_fitur"> Nama Jenis Fitur : </label>
            <input type="text" name="nama_jenis_fitur" id="nama_jenis_fitur" class="form-control" required>
          </div>
