...
<main>
   ...
   <div class="breadcrumb__area theme-bg-1 p-relative z-index-11 pt-95 pb-95">
      <div class="breadcrumb__thumb" data-background="<?= base_url() ?>asset/adina_asset/imgs/bg/breadcrumb-bg.jpg"></div>
      <div class="container">
   ...
   <section class="about-area pt-120 pb-120">
      <div class="container">
         ...
         <img class="w-100" src="<?= base_url() ?>asset/adina_asset/imgs/furniture/about/about-image2.jpg" alt="">
      </div>
   </div>
   <div class="col-xxl-6 col-xl-6 col-lg-6">
      <img class="w-100 pl-50" src="<?= base_url() ?>asset/adina_asset/imgs/furniture/about/about-image1.jpg" alt="">
   </div>
</div>
</div>
</section>
...
<div class="postbox__thumb postbox__video w-img p-relative">
   <a href="blog-details.html">
      <img src="<?= base_url() ?>asset/adina_asset/imgs/furniture/about/about-video-image.jpg" alt="image">
   </a>
                        ...
                        <div class="support-content">
                           ...
                           <div class="mobile__app-download">
                              <a class="app__download" href="#">
                                 <img src="<?= base_url() ?>asset/adina_asset/imgs/app/play-store.png" alt="image not found">
                              </a>
                              <a class="app__download" href="#">
                                 <img src="<?= base_url() ?>asset/adina_asset/imgs/app/apple-store.png" alt="image not found">
                              </a>
                           </div>
                        </div>
                     </div>
