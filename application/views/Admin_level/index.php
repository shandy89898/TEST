              ...
              <table id="example1" class="table">
                <thead>
                  <tr>
                    <th>Id Level</th>
                    <th> Nama Level </th>
                    <th> User Admin ( Penambah Data ) </th>
                    <th> Status </th>
                    <th> Waktu </th>
                    <th> Action </th>
                  </tr>
                ...
                <tbody>
                  <?php foreach ($data_level as  $row_level ) {?>
                    <tr>
                      ...
                      <td> <?= $row_level['id_level']  ?> </td>
                      <td> <?= $row_level['nama_level']  ?> </td>
                      <td> <?= $row_level['user_admin']  ?> </td>
                      <td class="kolom_status <?= $row_level['status'] ?>">
                        <button class="btn btn-default">
                          <?= $row_level['status'] ?> 
                        </button> 
                      </td>
                      <td> <?= $row_level['waktu']  ?> </td>
                      <td>
                        <!-- Kolom Opt -->
                        <div class="kolom_opt">
                          ...
                          <div class="menu_opt">
                            ...
                            <?php if ( $row_level['status'] == "ACTIVE" ){ ?>
                              <!-- Jika datanya belum dihapus, maka hapus datanya -->
                              <!-- Menghapus Data -->

                              <a href="<?= base_url() ?>Admin_level/delete_data/<?= $row_level['id_level']  ?>">
                                <div class="menu_colom">
                                  <div class="col_icon">
                            ...
                            <?php }else{ ?>
                              ...
                              <a href="<?= base_url() ?>Admin_level/restore_data/<?= $row_level['id_level']  ?>">
                                <div class="menu_colom">
                                  <div class="col_icon">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="<?= base_url() ?>Admin_level/tambah" method="post">
