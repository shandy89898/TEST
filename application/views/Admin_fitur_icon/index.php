    ...
    <form method="post" action="#">
      <div class="container-fluid container_indicator">
        ...
        <div class="col-sm-6 col_info_produk">
          <p class="title_info"> Id Fitur : </p>
          <p class="data_info"> <?= $row_fitur['id_fitur'] ?> </p>
        </div>
        <div class="col-sm-6 col_info_produk">
          <p class="title_info"> Nama Fitur : </p>
          <p class="data_info"> <?= $row_fitur['nama_fitur'] ?> </p>
        </div>
        ...
        <div class="card card_table">
          ...
          <div class="card-body">
            ...
            <table id="example1" class="table">
              ...
              <tbody>
                <?php foreach ($data_fitur_icon as $row_fitur_icon ) {?>
                  <tr>
                    <td> <?= $row_fitur_icon['id_fitur_icon'] ?> </td>
                    <td> <?= $row_fitur_icon['id_fitur'] ?> </td>
                    <td>
                      <img src="<?= $this->Base_model->get_imgFiturIcon( $row_fitur_icon ) ?>" style="width: 70px;height: 70px">
                      <p> 
                        <span> Url File :</span>
                        <?= $row_fitur_icon['file_gambar'] ?> 
                      </p>
                    </td>
                    <td> <?= $row_fitur_icon['waktu'] ?> </td>
                    <td>
                      <!-- Kolom Opt -->
                      <div class="kolom_opt">
                        ...
                        <div class="menu_opt">
                          <!-- Menghapus Data -->
                          <a href="<?= base_url() ?>Admin_fitur_icon/hapus?id_fitur=<?=$row_fitur_icon['id_fitur'] ?>&id_fitur_icon=<?= $row_fitur_icon['id_fitur_icon'] ?>">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="<?= base_url() ?>Admin_fitur_icon/tambah?id_fitur=<?= $row_fitur['id_fitur'] ?>" method="post" enctype="multipart/form-data">
          ...
          <div class="box_upload">
            ...
            <!-- Another dimension -->
            <input type="file" name="upload_gambar_fiturIcon" class="upload_img">
