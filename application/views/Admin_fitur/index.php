            ...
            <div class="card-body">
              ...
              <table class="table" border="1">
                <tr>
                  <th> Id Fitur </th>
                  <th> Nama Menu(RL) </th>
                  <th> Nama Jenis Fitur(RL) </th>
                  <th> Id Template (RL) </th>
                  <th> Nama Fitur </th>
                  <th> Waktu </th>
                  <th> Status </th>
                  <th> Action </th>
                ...
                <!-- Loop Data -->
                <?php foreach ($data_fitur as $key => $row_fitur): ?>
                  <tr>
                    <td> <?= $row_fitur['id_fitur'] ?> </td>
                    <td> 
                      <?php 
                      $id_jenis_fitur = $row_fitur['id_jenis_fitur'];
                      $jenis_fitur = $this->db->where('id_jenis_fitur', $id_jenis_fitur)->get('data_jenis_fitur')->row_array();
                      $id_menu = $jenis_fitur['id_menu'];
                      $menu = $this->db->where('id_menu', $id_menu)->get('data_menu')->row_array();
                      echo $menu['nama_menu'];
                      ?>
                    </td>
                    <td> <?= $row_fitur['nama_jenis_fitur'] ?> </td>
                    <td> <?= $row_fitur['id_template_fitur'] ?> </td>
                    <td> <?= $row_fitur['nama_fitur'] ?> </td>
                    <td> <?= $row_fitur['waktu'] ?> </td>
                    <td class="kolom_status <?= $row_fitur['status'] ?>">
                    ...
                    <td>
                      ...
                      <div class="kolom_opt">
                        ...
                        <div class="menu_opt">
                          ...
                          <a href="<?= base_url() ?>Admin_fitur/update/<?=$row_fitur['id_fitur']?>">
                          ...
                          <a href="<?= base_url() ?>Admin_fitur_icon?id_fitur=<?=$row_fitur['id_fitur']?>">
                            <div class="menu_colom">
                              <div class="col_icon">
                                <i class="fas fa-pen"></i>
                              </div>
                          ...
                          <?php if ( $row_fitur['status'] == "ACTIVE" ){ ?>
                            <!-- Jika datanya belum dihapus, maka hapus datanya -->
                            <!-- Menghapus Data -->

                            <a href="<?= base_url() ?>Admin_fitur/delete_data/?id_fitur=<?=$row_fitur['id_fitur']?>">
                              <div class="menu_colom">
                                <div class="col_icon">
                          ...
                          <?php }else{ ?>
                            ...
                            <a href="<?= base_url() ?>Admin_fitur/restore_data/?id_fitur=<?=$row_fitur['id_fitur']?>">
                              <div class="menu_colom">
                                <div class="col_icon">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <form action="<?=base_url()?>Admin_fitur/tambah" method="post">

        <div class="form-group">
          <label for="id_jenis_fitur"> List Jenis Fitur Relasi :</label>
          <select class="form-control" id="id_jenis_fitur" name="id_jenis_fitur">
            <?php 
            foreach ($data_jenis_fitur as $key => $row_jenis_fitur) {?>
              <option value="<?= $row_jenis_fitur['id_jenis_fitur'] ?>"> <?=$row_jenis_fitur['nama_jenis_fitur'] ?> - <?= $row_jenis_fitur['nama_menu']  ?> </option>
            <?php } ?>
          </select>
        </div>

        <div class="form-group">
          <label for="id_template_fitur"> List Template Fitur Relasi :</label>
          <select class="form-control" id="id_template_fitur" name="id_template_fitur">
            <?php 
            foreach ($data_template_fitur as $key => $row_jenis_fitur) {?>
              <option value="<?= $row_jenis_fitur['id_template_fitur'] ?>"> <?=$row_jenis_fitur['nama_template'] ?> </option>
            <?php } ?>
          </select>
        </div>
